...
import org.oxygen.redio.runtime.PacketNode
...
} with BlockBase(Material.circuits) with PacketNode
{
	...
	override def matchTarget(world: IBlockAccess, pos: BlockPos, name: String): Boolean = false
	override def dispatchPacket(world: IBlockAccess, pos: BlockPos, packet: RedObject): RedObject = null
